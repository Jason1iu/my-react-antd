...
export interface FormSubmitProps extends FormComponentProps {
    dispatch: Dispatch;
}
 ...
 * 创建Form表单
 */
class FormSubmit extends React.Component<FormSubmitProps>{

    constructor(props: FormSubmitProps) {
        super(props);

        props.dispatch(Actions.updateEditReduxState({ infoKey: MenuKey.app } as EditReduxState));
    }
...
export default Form.create<FormSubmitProps>()(FormSubmit);
